...
My team (BrBots) decided to create a robot in the beetle weight category (1.4Kg). To learn robotics techniques and participate in another modality in robot competitions.

![bettle](/assets/img/batalha/batalha.jpg){: width="350" height="350" }
_Battle robot (larger is functional) and its miniature (smaller is not functional)._
...
3. Start date: <font color="#fbb117">November/2017</font>
